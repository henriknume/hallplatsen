...
public class CardAdapter extends RecyclerView.Adapter<CardAdapter.MyViewHolder> {
          ...
          //  progressBar = (ProgressBar) view.findViewById(R.id.card_progressbar);
            switchBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Route tripCardOld = cards.get(current);
    ...
    public CardAdapter(Context mContext, List<Route> cards) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        Route card = cards.get(position);
        holder.fromName.setText(card.getStationNameFrom());
        holder.toName.setText(card.getStationNameTo());
